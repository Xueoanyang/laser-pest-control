...
volatile uint8_t ucRegIndex = 0;
volatile uint16_t usRegDataBuff[4] = {0};
volatile uint32_t uiRegDataLen = 0;
...
//                CopeWitData(s_ucWitDataBuff[1], usData, 4);
                s_uiWitDataCnt = 0;
								...
								usRegDataBuff[0] = usData[0];
								usRegDataBuff[1] = usData[1];
								usRegDataBuff[2] = usData[2];
								usRegDataBuff[3] = usData[3];
								uiRegDataLen = 4;
            }
        break;
